...
Solutions: Loop over list of num and store nums in a dict with indexes as values. Check if target - current number is already is dict -> return indexes else store current number and its index in dict. 
